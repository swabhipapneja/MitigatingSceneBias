...
class FeatureExtractor(nn.Module):
    def __init__(self, num_classes=101):
        ...
        # Replace this with your feature extractor model
...
if __name__ == "__main__":
    ...
    model.fc = torch.nn.Linear(model.fc.in_features, 48)  # Update for 48 for Diving48 dataset, 51 for HMDB51 AND 101 FOR UCF101 dataset
    # Loading the pretrained weights
    pretrained_weights = torch.load("models_saved/debiasing_model_without_gradient_reversal_for_HMV.pth")
    ...
    torch.save(model.state_dict(), "debiasing_diving48_trained_model.pth")
    print("Model saved to debiasing_diving48_trained_model.pth")
